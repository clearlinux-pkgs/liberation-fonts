...
Version  : 2.1.5
Release  : 10
URL      : https://github.com/liberationfonts/liberation-fonts/archive/2.1.5/liberation-fonts-2.1.5.tar.gz
Source0  : https://github.com/liberationfonts/liberation-fonts/archive/2.1.5/liberation-fonts-2.1.5.tar.gz
...
%prep
%setup -q -n liberation-fonts-2.1.5
cd %{_builddir}/liberation-fonts-2.1.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633034337
export GCC_IGNORE_WERROR=1
export CFLAGS="$CFLAGS -fno-lto "
export FCFLAGS="$FFLAGS -fno-lto "
export FFLAGS="$FFLAGS -fno-lto "
export CXXFLAGS="$CXXFLAGS -fno-lto "
make  %{?_smp_mflags}  build DISTPREFIX_TTF=truetype/liberation
...
cp %{_builddir}/liberation-fonts-2.1.5/LICENSE %{buildroot}/usr/share/package-licenses/liberation-fonts/0898cb73de9283d38e6f4cef45ce79efbfafb0b2
%make_install DISTPREFIX_TTF=truetype/liberation
