...
License  : OFL-1.1
Requires: liberation-fonts-license
Requires: liberation-fonts-data
...
%prep
%setup -q -n liberation-fonts-2.00.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1537898967
make  %{?_smp_mflags}

%install
export SOURCE_DATE_EPOCH=1537898967
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/liberation-fonts
cp LICENSE %{buildroot}/usr/share/doc/liberation-fonts/LICENSE
%make_install :||
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/liberation-fonts/LICENSE
