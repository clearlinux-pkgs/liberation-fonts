...
Version  : 2.1.3
Release  : 8
URL      : https://github.com/liberationfonts/liberation-fonts/archive/2.1.3/liberation-fonts-2.1.3.tar.gz
Source0  : https://github.com/liberationfonts/liberation-fonts/archive/2.1.3/liberation-fonts-2.1.3.tar.gz
...
%prep
%setup -q -n liberation-fonts-2.1.3
cd %{_builddir}/liberation-fonts-2.1.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614274475
...
cp %{_builddir}/liberation-fonts-2.1.3/LICENSE %{buildroot}/usr/share/package-licenses/liberation-fonts/0898cb73de9283d38e6f4cef45ce79efbfafb0b2
