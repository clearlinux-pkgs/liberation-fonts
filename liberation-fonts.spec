...
Version  : 2.1.4
Release  : 9
URL      : https://github.com/liberationfonts/liberation-fonts/archive/2.1.4/liberation-fonts-2.1.4.tar.gz
Source0  : https://github.com/liberationfonts/liberation-fonts/archive/2.1.4/liberation-fonts-2.1.4.tar.gz
...
%prep
%setup -q -n liberation-fonts-2.1.4
cd %{_builddir}/liberation-fonts-2.1.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620166621
...
cp %{_builddir}/liberation-fonts-2.1.4/LICENSE %{buildroot}/usr/share/package-licenses/liberation-fonts/0898cb73de9283d38e6f4cef45ce79efbfafb0b2
