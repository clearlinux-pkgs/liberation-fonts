...
Version  : 2.1.1
Release  : 6
URL      : https://github.com/liberationfonts/liberation-fonts/archive/2.1.1/liberation-fonts-2.1.1.tar.gz
Source0  : https://github.com/liberationfonts/liberation-fonts/archive/2.1.1/liberation-fonts-2.1.1.tar.gz
...
%prep
%setup -q -n liberation-fonts-2.1.1
cd %{_builddir}/liberation-fonts-2.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605725193
...
cp %{_builddir}/liberation-fonts-2.1.1/LICENSE %{buildroot}/usr/share/package-licenses/liberation-fonts/0898cb73de9283d38e6f4cef45ce79efbfafb0b2
:
